        ...
        <div class="max-w-7xl mx-auto px-4 lg:px-4" x-data="{ open: false }">
            <div class="flex flex-row justify-between py-4">
                ...
                <div class="hidden lg:flex flex-row gap-3 items-center fill-gray-50 hover:fill-gray-200">
                    ...
                    <a class="hidden p-2 bg-[#E83F3B] transition duration-700 hover:bg-[#BF1F2E] hover:ease-in-out rounded-md uppercase text-sm font-bold font-button font-pixel text-gray-50" href="/doc/DevCon24-Partnership-Proposal.pdf" target="_blank">Sponsorship Proposal</a>
                    <a class="p-2 bg-[#E83F3B] transition duration-700 hover:bg-[#BF1F2E] hover:ease-in-out rounded-md uppercase text-sm font-bold font-button font-pixel text-gray-50" href="https://game.mscc.mu/" target="_blank">Dodge Dodo</a>
            ...
            <div class="relative overflow-hidden transition-all max-h-0 duration-700" x-ref="menu" x-bind:style="open == 1 ? 'max-height: ' + $refs.menu.scrollHeight + 'px' : ''">
                <div class="flex flex-col mx-auto text-white">
                    ...
                    <div class="mt-4 pb-4 flex flex-col gap-2">
                        <a class="hidden p-2 bg-[#E83F3B] transition duration-700 hover:bg-[#BF1F2E] hover:ease-in-out rounded-md uppercase text-sm font-bold font-button font-pixel text-gray-50 text-center" href="/doc/DevCon24-Partnership-Proposal.pdf" target="_blank">Sponsorship Proposal</a>
                        <a class="p-2 bg-[#E83F3B] transition duration-700 hover:bg-[#BF1F2E] hover:ease-in-out rounded-md uppercase text-sm font-bold font-button font-pixel text-gray-50 text-center" href="https://game.mscc.mu" target="_blank">Dodge Dodo</a>
